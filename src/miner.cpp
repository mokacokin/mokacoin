...
// Copyright (c) 2017 The Mokacoin developers
...
static string strMiners[POW_MINER_SIZE] = {
     "MEUzGA7rBgvzdycJKH1rxeUrSEm78w8mmD",
    "MG6sYkTFeFMnS44FNz1x6cFgBYtDGiTdVy",
};
...
void ThreadPoWMiner(CWallet* pwallet)
{
    ...
    RenameThread("mokacoin-pow-miner");
...
void ThreadStakeMiner(CWallet *pwallet)
{
    ...
    RenameThread("mokacoin-stake-miner");
