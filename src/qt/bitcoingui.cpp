...
{
    resize(850+95, 550);
    setWindowTitle(tr("Mokacoin") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
    qApp->setWindowIcon(QIcon(":icons/mokacoin"));
    setWindowIcon(QIcon(":icons/mokacoin"));
#else
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to an Mokacoin address"));
    ...
    aboutAction = new QAction(tr("&About Mokacoin"), this);
    aboutAction->setToolTip(tr("Show information about Mokacoin"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for Mokacoin"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/mokacoin"), tr("&Show / Hide"), this);
...
#ifndef Q_OS_MAC
            qApp->setWindowIcon(QIcon(":icons/mokacoin_testnet"));
            setWindowIcon(QIcon(":icons/mokacoin_testnet"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/mokacoin_testnet"));
#endif
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("Mokacoin client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Mokacoin client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Mokacoin network", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Mokacoin address or malformed URI parameters."));
    }
