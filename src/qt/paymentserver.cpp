...
const QString BITCOIN_IPC_PREFIX("mokacoin:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click mokacoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start mokacoin: click-to-pay handler");
    else
...
{
    // clicking on mokacoin: URLs creates FileOpen events on the Mac:
