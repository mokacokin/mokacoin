...
bool parseBitcoinURI(const QUrl &uri, SendCoinsRecipient *out)
{
    ...
    if(uri.scheme() != QString("mokacoin"))
        return false;
...
{
    // Convert mokacoin:// to mokacoin:
    //
    //    Cannot handle this later, because mokacoin:// will cause Qt to see the part after // as host,
    //    which will lower-case it (and thus invalidate the address).
    if(uri.startsWith("mokacoin://"))
    {
        uri.replace(0, 12, "mokacoin:");
    }
...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "mokacoin.lnk";
}

bool GetStartOnSystemStartup()
{
    // check for mokacoin.lnk
...
{
    return GetAutostartDir() / "mokacoin.desktop";
}
...
bool SetStartOnSystemStartup(bool fAutoStart)
{
    ...
    else
    {
        ...
        if (!optionFile.good())
            return false;
        // Write an mokacoin.desktop file to the autostart directory:
        optionFile << "[Desktop Entry]\n";
        optionFile << "Type=Application\n";
        optionFile << "Name=mokacoin\n";
...
HelpMessageBox::HelpMessageBox(QWidget *parent) :
    QMessageBox(parent)
{
    header = tr("Mokacoin") + " " + tr("version") + " " +
        QString::fromStdString(FormatFullVersion()) + "\n\n" +
        tr("Usage:") + "\n" +
        "  mokacoin [" + tr("command-line options") + "]                     " + "\n";
