...
# also add new translations to src/qt/mokacoin.qrc under translations/
TRANSLATIONS = $$files(src/qt/locale/mokacoin_*.ts)
...
OTHER_FILES += \
    doc/*.rst doc/*.txt doc/README README.md res/mokacoin.rc
...
windows:RC_FILE = src/qt/res/mokacoin.rc
...
macx:ICON = src/qt/res/icons/mokacoin.icns
macx:TARGET = "mokacoin"
